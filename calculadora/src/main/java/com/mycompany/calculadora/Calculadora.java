...
public class Calculadora extends WindowAdapter implements ActionListener {

    Frame f;
Label l1;
Button b1, b2, b3, b4, b5, b6, b7, b8, b9, b0;
Button bsom, bsub, bmult, bdiv, bmod, bcalc, bclr, bpts, bneg, bback;
double xd;
...
Calculadora () {
    ...
    f.add(bsom); f.add(bsub); f.add(bmult); f.add(bdiv); f.add(bmod); f.add(bcalc);
    
    f.add(bclr); f.add(bpts); f.add(bback); f.add(bneg);
